...
import { useGetTopAiringQuery } from "../services/animeApiQuery";
...
const TopAiringPage = () => {
    ...
    const { data, isError, isLoading, isFetching } = useGetTopAiringQuery({ page: pageParam });

    const animeList = data?.results || [];

    return (
        <>
            <PageTitle title="Top Airing" />

    ...
    return (
        <footer className="bg-black/10 py-10 mt-10">
            <div className="container grid lg:grid-cols-[1fr_3fr] gap-y-10">
                ...
                >
                    <h2 className="font-semibold text-2xl">AnimeWatch </h2>
                </Link>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-10">
                    <div className="space-y-4">
                        <h2 className="font-semibold"> About </h2>
                        <p className="max-w-[300px]">
                            A simple anime streaming site built for educational
                            and project purposes only.
                        </p>
                    </div>
                    <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-1">
                            <Link
                                ...
                                className="hover:text-secondary-accent focus:text-secondary-accent outline-none"
                            >
                                <LinkedInIcon className="h-10 w-10 p-0" />
                            </Link>
                            <Link
                                to={"/"}
                                target="_blank"
                                aria-label="link to creator's instagram"
                                className="hover:text-secondary-accent focus:text-secondary-accent outline-none"
                            >
                                <InstagramIcon className="h-10 w-10 p-0" />
                            </Link>
                        </div>
                    </div>
                </div>

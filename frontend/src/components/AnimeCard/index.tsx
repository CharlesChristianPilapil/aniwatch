    ...
    return (
        <Card className="bg-transparent text-main space-y-2">
            <div className="group relative after:absolute after:bottom-0 after:left-0 after:h-[40px] after:w-full after:bg-gradient-to-t after:from-background after:to-transparent after:content-['']">
                ...
                <Link 
                    to={`/info/${props.id}`} 
                    className="absolute top-0 left-0 w-full h-full bg-background/25 backdrop-blur-sm flex items-center justify-center invisible opacity-0 group-hover:opacity-100 group-hover:visible transition-all duration-200"
                >  
            ...
            <div className="px-2 pb-2 space-y-1">
                ...
                <div className="flex items-center justify-between">
                    <p className="flex items-center gap-1 lg:gap-2 text-xs">  
                        ...
                        <span className="h-1 w-1 bg-main rounded-full" aria-hidden />
